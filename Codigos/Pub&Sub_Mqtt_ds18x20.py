...
MQTT_TOPIC_SUB_RESISTENCIAS = ['temperatura/control/1','temperatura/control/2','temperatura/control/3','temperatura/control/4','temperatura/control/5']

# MQTT Parametros
MQTT_SERVER = b'192.168.196.47'
MQTT_PORT = 1883
MQTT_USER = None
MQTT_PASSWORD = None
